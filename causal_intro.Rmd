...
\begin{itemize}
  ...
  \begin{itemize}
      ...
      \item[e.] Positivity
  \end{itemize}
  \item Identifiability: Effect of Treatment on the Treated
    \begin{itemize}
...
\noindent {\Large \bf Identifiability: Effect of Treatment on the Treated}

Let's review what we've covered so far. We defined our causal effect of interest as the average treatment effect for a binary outcome / exposure, we we choose to be the causal risk difference:
$$ E (Y^{x=1}  - Y^{x=0})  $$
